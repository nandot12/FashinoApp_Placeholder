 ...
 */
class RecycleAdapter_GridList_3_filter(internal var context: Context) : RecyclerView.Adapter<RecycleAdapter_GridList_3_filter.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = LayoutInflater.from(parent.context)
                .inflate(R.layout.item_filter_list2, parent, false)
