 ...
 */
class RecycleAdapter_ProductListGrid_2(internal var context: Context, private val moviesList: List<BeanClassForProductList>) : RecyclerView.Adapter<RecycleAdapter_ProductListGrid_2.MyViewHolder>() {
