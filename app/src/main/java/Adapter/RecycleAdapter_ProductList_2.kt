 ...
 */
class RecycleAdapter_ProductList_2(internal var context: Context, private val moviesList: List<BeanClassForProductList>) : RecyclerView.Adapter<RecycleAdapter_ProductList_2.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = LayoutInflater.from(parent.context)
                .inflate(R.layout.item_product_list_2, parent, false)
