 ...
 */
class RecycleAdapter_Similar_product(internal var context: Context, private val moviesList: List<BeanClassForProductList>) : RecyclerView.Adapter<RecycleAdapter_Similar_product.MyViewHolder>() {
