 ...
 */
class RecycleviewAdapter_Treding(internal var mContext: Context, private val modalClassList: List<TredingModalClass>) : RecyclerView.Adapter<RecycleviewAdapter_Treding.MyViewHolder>() {
