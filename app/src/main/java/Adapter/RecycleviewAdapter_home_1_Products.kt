 ...
 */
class RecycleviewAdapter_home_1_Products(internal var mContext: Context, private val modalClassList: List<Home1_TredingModalClass>) : RecyclerView.Adapter<RecycleviewAdapter_home_1_Products.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = LayoutInflater.from(parent.context)
                .inflate(R.layout.item_fetured_home_1, parent, false)
