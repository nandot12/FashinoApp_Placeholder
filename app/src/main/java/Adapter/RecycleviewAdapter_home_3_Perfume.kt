 ...
 */
class RecycleviewAdapter_home_3_Perfume(internal var mContext: Context, private val modalClassList: List<Home3_ProductModalClass>) : RecyclerView.Adapter<RecycleviewAdapter_home_3_Perfume.MyViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MyViewHolder {
        val itemView = LayoutInflater.from(parent.context)
                .inflate(R.layout.item_perfume_list, parent, false)
